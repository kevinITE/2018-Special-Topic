    ...
    SampleAppMenuInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(inst.size() > 0)
            txtView_inst.setText(inst.get(0));
        ...
        layout = (RelativeLayout) findViewById(R.id.camera_overlay_textreco);
    ...
    private void Alert_build(AlertDialog.Builder AlertDialog, final int beacon_m) {
        AlertDialog.setNegativeButton("Detail", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent introduction = new Intent(TextReco.this, iBeaconDetail.class);
                switch (beacon_m){
                    case 24372:
